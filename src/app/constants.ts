...
export const education = {
  title: 'Bachelor of Engineering in Computer Science - Expected April 2025',
  desc: `At McMaster University, my academic journey in Computer Science has
...
export const skills = [
  ...
  },
  {
    ...
    data: ['HTML', 'CSS', 'ReactJS', 'Tailwind CSS'],
  },
  {
